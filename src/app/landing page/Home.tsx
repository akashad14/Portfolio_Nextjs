      ...
      <motion.div className="space-y-8" 
        ...
        transition={{ duration: 1 }}>
            <div className="space-y-4">
              ...
              <motion.h1 className="text-4xl font-bold tracking-tight text-gray-900 dark:text-white sm:text-5xl" initial={{ y: -20, opacity: 0 }} animate={{ y: 0, opacity: 1 }} transition={{ duration: 1 }}>
                I&apos;m <span className="text-purple-600 dark:text-purple-400">A Graphic Designer</span>
              </motion.h1>
              <motion.p className="text-lg leading-relaxed text-gray-600 dark:text-gray-300" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 1.2 }}>
            ...
            <motion.div className="flex flex-wrap gap-4" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 1.5 }}>
              <motion.button
                ...
                className="inline-flex items-center justify-center rounded-full bg-purple-600 px-6 py-3 text-sm font-medium text-white transition-colors hover:bg-purple-700"
              >
                Hire Me
              </motion.button>
              <motion.button whileHover={{ scale: 1.1 }} whileTap={{ scale: 0.9 }} onClick={handleDownloadCV} className="inline-flex items-center justify-center gap-2 rounded-full bg-gray-900 px-6 py-3 text-sm font-medium text-white transition-colors hover:bg-gray-800">
                Download My CV
          ...
          <motion.div initial={{ opacity: 0, scale: 0.8 }} animate={{ opacity: 1, scale: 1 }} transition={{ duration: 1 }} whileHover={{ rotate: 5 }} className="relative mx-auto aspect-square w-full max-w-lg lg:mx-0">
